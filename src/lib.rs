...
pub use CanColor = can_color::CanColor;
pub use CanRectangle = can_rectangle::CanRectangle;
pub use CanTransform = can_transform::CanTransform;
pub use HasColor = has_color::HasColor;
pub use HasRectangle = has_rectangle::HasRectangle;
pub use HasTransform = has_transform::HasTransform;
